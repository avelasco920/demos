...
var _stock = __webpack_require__(27);
...
document.addEventListener("DOMContentLoaded", function () {
	...
	_reactDom2.default.render(_react2.default.createElement(_stock2.default, null), root);
});
...
var _normalizr = __webpack_require__(30);
...
var Stock = function (_React$Component) {
  ...
  function Stock() {
    ...
    var _this = _possibleConstructorReturn(this, (Stock.__proto__ || Object.getPrototypeOf(Stock)).call(this));
  ...
  _createClass(Stock, [{
    ...
    value: function fetchData() {
      $.ajax({
        ...
        success: function (resp) {
          ...
          console.log(resp);
          this.setState({ timeSeries: resp["Time Series (Daily)"] }, function () {
            _this2.closingPrices();
          });
        }.bind(this),
    ...
    key: 'closingPrices',
    value: function closingPrices() {
      var _this3 = this;

      var timeSeriesArr = Object.values(this.state.timeSeries);
      var newArr = Array.from(timeSeriesArr).map(function (el) {
        return parseFloat(el["4. close"]);
      });
      this.setState({ timeSeries: newArr }, function () {
        return console.log(_this3.state.timeSeries);
      });
      return newArr;
    }
  }, {
...
var _ImmutableUtils = __webpack_require__(28);
...
var _Union = __webpack_require__(32);
...
var _Polymorphic = __webpack_require__(29);
